...
<head>
    ...
    <title>Mura'g Facebook</title>
</head>
<body>

<div class="header_bar">
    <a href="index1.php" style="text-decoration: none; color: #44c2d8;"><img src="logo.png" alt="O" style="height: 40px; width: 40px; margin: 18px 3px -10px 30px;">
    <span style="font-family: Roboto;/*! text-decoration: none; */font-size: 26px;"></span></a>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
            <div class="dropdown-a">
                ...
                <a href="#" onclick="confirmLogout()"><i class="fas fa-sign-out-alt fa-lg" style="margin-right: 3px;"></i> Logout</a>
            </div>
        </div> 
  ...
  <nav>
        ...
        <a href="index1.php"> <i class="fas fa-home fa-lg"></i></a>
